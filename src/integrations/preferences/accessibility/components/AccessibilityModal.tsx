      ...
      <div className="a11y-modal-shell">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-2">
                <span className="shrink-0">
                  <Icon icon="fa6:universal-access" size="lg" className="text-white" />
                </span>
                <div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Icon icon="fa6:rotate-left" size="sm" className="text-white" />
                  <span
                    className={`absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-white text-gray-700 text-[10px] tracking-wide px-2 py-1 shadow-md transition-opacity ${
                ...
                <button
                  ...
                  className="a11y-header-action relative"
                >
                  <Icon icon="fa6:xmark" size="md" className="text-white" />
                  <span
                    className={`absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-white text-gray-700 text-[10px] tracking-wide px-2 py-1 shadow-md transition-opacity ${
        ...
        <div className="a11y-scroll-region w-full mx-auto">
          <div className="a11y-card a11y-card--spacious">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-700/70">
              Language
            </p>
            <div className="mt-3">
              <LanguageSwitcher />
          ...
          <div className="rounded-2xl border border-dashed border-gray-300/70 bg-gray-200/40 p-4 text-xs text-gray-700/70">
  ...
  return (
    <section className="space-y-3">
      <div>
        ...
        {description && (
          <p className="text-xs text-gray-700/70">{description}</p>
        )}
      </div>
      {children}
    </section>
  ...
  return (
    <div className="a11y-card a11y-card--compact">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm font-semibold text-black">{valueLabel}</span>
      </div>
      <input
        type="range"
        min={min}
            ...
            <button
              ...
              className={`flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-semibold transition ${
                isActive
                  ...
                  : "border-transparent bg-white text-gray-700 hover:border-black/40"
              }`}
            >
              {option.icon && (
...
function IconBadge({ icon, active = false, size = "sm" }: IconBadgeProps) {
  ...
  const wrapperClasses = [
    ...
    sizeClasses[size],
    active ? "bg-gray-700 text-white" : "bg-black text-white",
  ]
    .filter(Boolean)
    .join(" ");
